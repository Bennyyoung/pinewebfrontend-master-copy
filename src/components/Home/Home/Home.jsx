...
function Home() {
 ...
 const handleClickAction = (userId) => {
  setId(userId)
  id && history.push(generatePath("/details-new/:id", {
   id
  }))
 }
 return (
      ...
      <table className="table">
       ...
       <tbody>
        {trips.map((trip, index) => {
         ...
         return (
          <tr key={index}>
           <td><Link onClick={() => handleClickAction(trip.recipient_id)} to={"/details-new/" + trip.recipient_id} style={{ textDecoration: 'none', color: 'black' }}>
            {trip.recipient.name}
           </Link></td>
           <td><Link to={"/details-new/" + trip.recipient_id} style={{ textDecoration: 'none', color: 'black' }}>
            {trip.goods.name}
           </Link></td>
           <td><Link to={"/details-new/" + trip.recipient_id} style={{ textDecoration: 'none', color: 'black' }}>
