...
<div class="row px-4">
  ...
  <div class="column-2 px-4">
    ...
    <div className="px-5">
    <p className="text-center text-secondary px-5 text">Youy cannot edit or change your company name again after this screen, so confirm that the spelling is correct.</p>
    </div>
